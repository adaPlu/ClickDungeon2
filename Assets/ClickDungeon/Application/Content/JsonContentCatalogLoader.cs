...
namespace ClickDungeon.Application.Content
{
    public sealed class JsonContentCatalogLoader
    {
        ...
        private static HeroClassId ParseClass(string id){switch(id){case "class.knight":return HeroClassId.Knight;case "class.ranger":return HeroClassId.Ranger;case "class.thief":return HeroClassId.Thief;case "class.wizard":return HeroClassId.Wizard;case "class.paladin":return HeroClassId.Paladin;case "class.berserker":return HeroClassId.Berserker;case "class.engineer":return HeroClassId.Engineer;case "class.cleric":return HeroClassId.Cleric;default:throw new InvalidDataException($"Unknown hero class id {id}.");}}

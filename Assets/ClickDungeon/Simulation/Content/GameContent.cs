...
namespace ClickDungeon.Simulation.Content
{
    public sealed class GameContent
    {
        ...
        public static GameContent CreateDevelopmentFallback()
        {
            ...
            c.Add(new HeroDefinition { ClassId=HeroClassId.Paladin, BaseHp=17, BaseAttack=2, BaseDefense=2, AbilityIds=new[]{"ability.paladin.radiant_strike","ability.paladin.lay_on_hands","ability.paladin.consecration","ability.paladin.aegis_of_dawn","ability.paladin.divine_bulwark"} });
            c.Add(new HeroDefinition { ClassId=HeroClassId.Berserker, BaseHp=16, BaseAttack=4, BaseDefense=0, AbilityIds=new[]{"ability.berserker.cleaving_blow","ability.berserker.bloodrush","ability.berserker.war_cry","ability.berserker.frenzy","ability.berserker.ragequake"} });
            c.Add(new HeroDefinition { ClassId=HeroClassId.Engineer, BaseHp=14, BaseAttack=2, BaseDefense=1, AbilityIds=new[]{"ability.engineer.shock_wrench","ability.engineer.barrier_drone","ability.engineer.snare_mine","ability.engineer.overclock","ability.engineer.clockwork_barrage"} });
            c.Add(new HeroDefinition { ClassId=HeroClassId.Cleric, BaseHp=15, BaseAttack=2, BaseDefense=1, AbilityIds=new[]{"ability.cleric.smite","ability.cleric.mend","ability.cleric.sanctuary","ability.cleric.blessing","ability.cleric.radiant_renewal"} });
            ...
            AddAbilities(c,HeroClassId.Paladin,new[]{("ability.paladin.radiant_strike",3,8),("ability.paladin.lay_on_hands",2,10),("ability.paladin.consecration",2,10),("ability.paladin.aegis_of_dawn",2,11),("ability.paladin.divine_bulwark",1,14)});
            AddAbilities(c,HeroClassId.Berserker,new[]{("ability.berserker.cleaving_blow",3,8),("ability.berserker.bloodrush",2,10),("ability.berserker.war_cry",2,10),("ability.berserker.frenzy",2,10),("ability.berserker.ragequake",1,14)});
            AddAbilities(c,HeroClassId.Engineer,new[]{("ability.engineer.shock_wrench",3,8),("ability.engineer.barrier_drone",2,9),("ability.engineer.snare_mine",2,9),("ability.engineer.overclock",2,10),("ability.engineer.clockwork_barrage",1,14)});
            AddAbilities(c,HeroClassId.Cleric,new[]{("ability.cleric.smite",3,8),("ability.cleric.mend",3,8),("ability.cleric.sanctuary",2,10),("ability.cleric.blessing",2,10),("ability.cleric.radiant_renewal",1,14)});
